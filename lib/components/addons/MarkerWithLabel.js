...
var MarkerWithLabel = exports.MarkerWithLabel = function (_React$PureComponent) {
  ...
  (0, _createClass3.default)(MarkerWithLabel, [{
    ...
    value: function componentDidMount() {
      ...
      this.containerRoot = _client2.default.createRoot(container);
      this.containerRoot.render(_react2.default.Children.only(this.props.children));
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (this.props.children !== prevProps.children) {
        _reactDom2.default.createPortal(_react2.default.Children.only(this.props.children), this.state[_constants.MARKER_WITH_LABEL].get("labelContent"));
      }
    }
  }, {
    ...
    value: function componentWillUnmount() {
      ...
      if (markerWithLabel) {
        ...
        if (markerWithLabel.get("labelContent")) {
          setTimeout(function () {
            if (_this2.containerRoot && typeof _this2.containerRoot.unmount === 'function') {
              _this2.containerRoot.unmount();
            }
          });
        }
